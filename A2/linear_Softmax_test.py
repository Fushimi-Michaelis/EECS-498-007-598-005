...
# --- Softmax loss naive implementation ---
...
# Check gradient without reg
f = lambda w: softmax_loss_naive(w, X_batch, y_batch, reg=0.0)[0]
eecs598.grad.grad_check_sparse(f, W, grad, 10)

# check gradient with reg
_, grad = softmax_loss_naive(W, X_batch, y_batch, reg=10.0)
...
# Best: lr 3.5e-2 reg 1e-3 train accuracy: 42.495000 val accuracy: 40.520000
...
# Result: softmax on raw pixels final test set accuracy: 0.405400
